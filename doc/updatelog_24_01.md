# Situation UPDATELOG — v2.4.x (part 1 of 5)

Patches **2.4.0 "Modular Revolution & Architectural Reorganization"** through **2.4.100 "SPIR-V Poll Diagnostics"** (100 entries, oldest first).

Index: [`UPDATELOG.md`](UPDATELOG.md) · Previous: — · Next: [`updatelog_24_02.md`](updatelog_24_02.md)
