...
**Related plans:** `doc/plan/v2.5-api-expansion.md`, `doc/plan/RENDERER_AUDIT_PLAN.md`, `doc/plan/TEST_HARNESS_GRAPHICS_UPGRADE.md`, `doc/plan/VD_EXTRACTION_PLAN.md`, [`doc/plan/VULKAN_SHADER_CACHE_PLAN.md`](VULKAN_SHADER_CACHE_PLAN.md).  
