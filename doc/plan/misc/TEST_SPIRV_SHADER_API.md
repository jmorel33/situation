...
See `doc/plan/SHADER_DEBUG_PLAN.md`. Demon Hunt reports **OpenGL** `.spv`; `harness` reports **OpenGL + Vulkan** harness blobs under `tests/harness/spirv_out/`.

---

See also: `doc/plan/SHADER_DEBUG_PLAN.md`, `doc/UPDATELOG.md` (v2.4.97–v2.4.102), `doc/plan/VULKAN_SPIRV_USER_DESCRIPTOR_PARITY.md`, `compile_demon_hunt_shaders.bat`, `compile_harness_shaders.bat`.
