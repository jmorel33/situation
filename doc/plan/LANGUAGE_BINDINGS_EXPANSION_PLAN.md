...
|----------|-------------|--------------|
| Odin | `build_odin_example.bat` | gendef → dlltool → odin build → copy DLL |
| Zig | `build_zig_example.bat` | zig build (build.zig handles linking) |
| Rust | `build_rust_example.bat` | cargo build (build.rs handles linking) |
