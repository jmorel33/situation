...
**Status**: **Complete** — shipped **v2.4.144** (Epics A–E, patches 139–144). API reference: `doc/THREADING_BOLSTERING_API.md`.
...
- [x] Dynamic scan depth from queue depth (`_SitWorkerScanDepthForPending`, 4–32)
