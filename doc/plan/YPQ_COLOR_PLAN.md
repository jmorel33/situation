...
- **`sit/situation_impl_ypq.h`** — all new function implementations (3.2, 3.3). The diagnostics functions use `_SitRgbFromYpqBytes` directly and have no image dependency, so they belong here alongside the rest of the YPQ math core.
