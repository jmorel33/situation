...
**Follow-on:** Second-level renderer split — **complete** (v2.4.360); see [`doc/done/RENDERER_MODULARIZATION_PLAN.md`](RENDERER_MODULARIZATION_PLAN.md)  
...
- `sit/situation_impl_renderer.h` — Renderer orchestrator (includes five slices; v2.4.360+)
- `sit/situation_impl_renderer_{core,lc,shader,resources,frame_cmd}.h` — Domain slices (see `doc/done/RENDERER_MODULARIZATION_PLAN.md`)
