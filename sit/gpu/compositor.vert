 ...
 *
 * @note Compile with -DSIT_COMPOSITOR_PATH_B for vd.frag (VDPushConstants, 96 B).
 * @note Compile with -DSIT_COMPOSITOR_PATH_A for composite.frag (CompositePushConstants, 112 B).
