@echo off
REM K-Term Test Suite Compilation - All Tests
REM Matches console example compilation approach
...
echo ========================================
echo K-Term Test Suite Compilation
...
set LIBS=-lm -lws2_32 -liphlpapi tinycthread.o
set FLAGS=-std=c11 %INCLUDES% %DEFINES% %LIBS%

REM Test 1: Parser Suite
echo [1/%TOTAL%] Compiling test_parser_suite...
gcc -o test_parser_suite.exe test_parser_suite.c %FLAGS%
if errorlevel 1 (
...
echo [2/%TOTAL%] Compiling test_attributes_modes_suite...
gcc -o test_attributes_modes_suite.exe test_attributes_modes_suite.c %FLAGS%
if errorlevel 1 (
...
echo [3/%TOTAL%] Compiling test_verification_suite...
gcc -o test_verification_suite.exe test_verification_suite.c %FLAGS%
if errorlevel 1 (
...
echo [4/%TOTAL%] Compiling test_graphics_suite...
gcc -o test_graphics_suite.exe test_graphics_suite.c %FLAGS%
if errorlevel 1 (
...
echo [5/%TOTAL%] Compiling test_gateway_suite...
gcc -o test_gateway_suite.exe test_gateway_suite.c %FLAGS%
if errorlevel 1 (
...
echo [6/%TOTAL%] Compiling test_networking_suite...
gcc -o test_networking_suite.exe test_networking_suite.c %FLAGS%
if errorlevel 1 (
...
echo [7/%TOTAL%] Compiling test_io_suite...
gcc -o test_io_suite.exe test_io_suite.c %FLAGS%
if errorlevel 1 (
...
echo [8/%TOTAL%] Compiling test_fuzz_suite...
gcc -o test_fuzz_suite.exe test_fuzz_suite.c %FLAGS%
if errorlevel 1 (
...
echo [9/%TOTAL%] Compiling stress_tests...
gcc -o stress_tests.exe stress_tests.c %FLAGS%
if errorlevel 1 (
...
echo [10/%TOTAL%] Compiling test_integration_suite...
gcc -o test_integration_suite.exe test_integration_suite.c %FLAGS%
if errorlevel 1 (
