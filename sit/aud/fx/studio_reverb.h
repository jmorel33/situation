...
static void _SituationStudioReverbProcess(SituationStudioReverb* reverb, const float* in_left, const float* in_right,
    ...
    for (int n = 0; n < num_samples; n++) {
        ...
        float dry_gain = 1.0f - reverb->params.wet_mix;
        out_left[n] = STUDIO_REV_FMA(wet_left, reverb->params.wet_mix, in_left[n] * dry_gain);
        out_right[n] = STUDIO_REV_FMA(wet_right, reverb->params.wet_mix, in_right[n] * dry_gain);
