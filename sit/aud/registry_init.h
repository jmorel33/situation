...
static void _SituationRegisterToneSynth(void) {
    ...
    strncpy(meta.controls[39].name, "lfo_reset_on_key", SITUATION_MAX_CONTROL_NAME - 1);
    meta.controls[39].id = 39;
    meta.controls[39].type = SITUATION_CONTROL_BOOL;
    meta.controls[39].min_value = 0.0f;
    meta.controls[39].max_value = 1.0f;
    meta.controls[39].default_value = 1.0f;
    meta.controls[39].units = NULL;
    meta.controls[39].is_logarithmic = false;

    strncpy(meta.controls[40].name, "lfo_start_phase", SITUATION_MAX_CONTROL_NAME - 1);
    meta.controls[40].id = 40;
    meta.controls[40].type = SITUATION_CONTROL_FLOAT;
    meta.controls[40].min_value = 0.0f;
    meta.controls[40].max_value = 1.0f;
    meta.controls[40].default_value = 0.0f;
    meta.controls[40].units = NULL;
    meta.controls[40].is_logarithmic = false;

    strncpy(meta.controls[41].name, "glide_reset_on_key", SITUATION_MAX_CONTROL_NAME - 1);
    meta.controls[41].id = 41;
    meta.controls[41].type = SITUATION_CONTROL_BOOL;
    meta.controls[41].min_value = 0.0f;
    meta.controls[41].max_value = 1.0f;
    meta.controls[41].default_value = 0.0f;
    meta.controls[41].units = NULL;
    meta.controls[41].is_logarithmic = false;
