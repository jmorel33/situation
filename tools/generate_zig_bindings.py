...
pub const SituationFont = extern struct {
    font_data: ?*anyopaque,
    stb_font_info: ?*anyopaque,
    atlas_texture: SituationTexture,
    glyph_info: ?*anyopaque,
    atlas_width: c_int,
    atlas_height: c_int,
...
pub const SituationPackedFont = extern struct {
    char_width: c_int,
    char_height: c_int,
...
pub const SituationPackedFont    = types.SituationPackedFont;
