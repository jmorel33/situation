...
pub struct SituationFont {
    ...
    pub stb_font_info: *mut c_void,
    pub atlas_texture: SituationTexture,
    pub glyph_info: *mut c_void,
    pub atlas_width: c_int,
    pub atlas_height: c_int,
    pub font_height_pixels: f32,
    pub is_bitmap: bool,
    pub bitmap_data: *const u8,
    pub bitmap_width: c_int,
    pub bitmap_height: c_int,
    pub bitmap_count: c_int,
    pub first_char: c_int,
    pub chars_per_row: c_int,
    pub chars_per_col: c_int,
    pub display_cell_width: c_int,
    pub display_cell_height: c_int,
...
#[repr(C)]
#[derive(Copy, Clone, Debug, Default)]
pub struct SituationPackedFont {
    ...
    pub first_char: c_int,
    pub chars_per_row: c_int,
    pub bits_per_row: c_int,
    pub data_bits: c_int,
    pub data_bit_offset: c_int,
    pub bit_order_msb_first: bool,
    pub top_padding: c_int,
    pub bottom_padding: c_int,
    pub left_padding: c_int,
    pub right_padding: c_int,
    pub atlas_chars_per_row: c_int,
    pub atlas_chars_per_col: c_int,
    pub enable_outline: bool,
    pub outline_thickness: c_int,
    pub outline_r: u8,
    pub outline_g: u8,
    pub outline_b: u8,
    pub outline_a: u8,
...
def render_opaque_stubs(entries: list[ApiEntry]) -> str:
    ...
    known_types = {
        ...
        "SituationTexture", "SituationShader", "SituationFont", "SituationPackedFont",
