...
CMD_REF_ANCHORS: dict[str, str] = {
    ...
    "SituationCmdBeginDebugGroup": "#9-debug-markers",
    "SituationCmdEndDebugGroup": "#9-debug-markers",
...
def main() -> None:
    ...
    api_md = API_MD.read_text(encoding="utf-8", errors="replace") if API_MD.exists() else ""
    ...
    print(f"situation_api.md: {present}/{len(entries)} ({len(missing)} missing)")
    if missing_in_ref:
