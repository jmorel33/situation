...
CTYPE_MAP: dict[str, str] = {
    ...
    "SituationPackedFont": "Situation_Packed_Font",
...
Situation_Font :: struct {
    font_data, stb_font_info, glyph_info: rawptr,
    atlas_texture: Situation_Texture,
    atlas_width, atlas_height: c.int,
    font_height_pixels: f32,
    is_bitmap: b32,
    bitmap_data: ^u8,
    bitmap_width, bitmap_height, bitmap_count: c.int,
    first_char, chars_per_row, chars_per_col: c.int,
    display_cell_width, display_cell_height: c.int,
    char_spacing, line_spacing: f32,
}

Situation_Packed_Font :: struct {
    char_width, char_height, display_height: c.int,
    char_count, first_char, chars_per_row: c.int,
    bits_per_row, data_bits, data_bit_offset: c.int,
    bit_order_msb_first: b32,
    top_padding, bottom_padding, left_padding, right_padding: c.int,
    atlas_chars_per_row, atlas_chars_per_col: c.int,
    enable_outline: b32,
    outline_thickness: c.int,
    outline_r, outline_g, outline_b, outline_a: u8,
    font_r, font_g, font_b, font_a: u8,
}
...
def render_opaque_stubs(entries: list[ApiEntry]) -> str:
    ...
    known_types = {
        ...
        "Situation_Texture", "Situation_Shader", "Situation_Font", "Situation_Packed_Font",
