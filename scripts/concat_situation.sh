...
#     ./scripts/concat_situation.sh [output_file]
#
#     Default output: situation_full.c
...
# --- Main ---
if [[ ! -f "sit/situation.h" ]]; then
    echo "Error: sit/situation.h not found. Run from the repo root: ./scripts/concat_situation.sh" >&2
    exit 1
fi
...

{
    ...
    echo "/* Do not edit. Regenerate with: ./scripts/concat_situation.sh */"
    concat_file "sit/situation.h"
} > "$OUTPUT"
